...
const prompt = ai.definePrompt({
  ...
  Based on the image, determine if a disease is present. If a disease is present, provide the name of the disease, symptoms, causes, treatments, and prevention methods. Use the shouldIncludeDiseaseInfo tool to determine if the information should be displayed.
